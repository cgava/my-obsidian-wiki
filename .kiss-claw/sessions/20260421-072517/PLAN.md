...
- [x] Step 2 — Revue globale (verificator) : analyser la doc complète (existant + ajouts) pour valider (a) la couverture exhaustive de J9-J15, (b) le respect strict du format Diataxis, (c) la cohérence terminologique et navigationnelle entre les 4 piliers, (d) l'exactitude technique vs le code réel — produire un REVIEW avec statut approved / approved-with-notes / needs-rework
- [x] Step 3 — Rework (executor, délégation 2) : traiter les remarques du verificator (y compris corrections éventuelles sur la doc J8 existante si le verificator les a identifiées comme nécessaires à la cohérence globale)
